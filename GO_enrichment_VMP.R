...
my_genes <- read.csv("/Users/emb3/Dropbox/Projects/bernice_vmp/MiniProject_BCh/FINALData/Gene_res_final.csv")

my_genes <- as.data.frame(na.omit(my_genes$genelist))
...
write.table(REVIGO,"/Users/emb3/Dropbox/Projects/kristi_epigenetic_clock/manuscript/long_form_paper/GO_analysis/VMP_GOs.txt",row.names = F,sep = "\t",quote = F)
